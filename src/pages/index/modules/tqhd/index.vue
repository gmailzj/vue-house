		...
		<tr>
			...
			<td class="counter_list counter_list_width3">
				<ul class="clearfix fl">
					<li>
						<span>还款类型：</span>
						<dropSelect :selectItem="repayType" @selectDrop="selectType" name="repayType" :defaultItem="selected.repayType"></dropSelect>
					</li>
					<li class="">
						<span>原房贷金额：</span>
					...
					<li>
						<span>原房贷年限：</span>
						<dropSelect :selectItem="repayTime" @selectDrop="selectType" name="repayTime" :defaultItem="selected.repayTime"></dropSelect>
					</li>
					<li class="">
						<span>利率：</span>
						<dropSelect :selectItem="rateType" @selectDrop="selectType" name="rateType" :defaultItem="selected.rateType"></dropSelect>
					</li>
					<li class="date_select clearfix">
						<span>第一次还款时间：</span>
						<dropSelect :selectItem="firstYear" @selectDrop="selectType" klass="date_right" name="firstYear" :defaultItem="selected.firstYear"></dropSelect>
						<dropSelect :selectItem="month" @selectDrop="selectType" name="firstMonth" :defaultItem="selected.firstMonth"></dropSelect>
					</li>
					<li class="date_select clearfix">
						<span>预计提前还款时间：</span>
						<dropSelect :selectItem="advYear" @selectDrop="selectType" klass="date_right" name="advYear" :defaultItem="selected.advYear"></dropSelect>
						<dropSelect :selectItem="month" @selectDrop="selectType" name="advMonth" :defaultItem="selected.advMonth"></dropSelect>
					</li>
					<li class="way_block">
						<span>还款方式：</span>
						...
						<p class="fangshi" @click="selectType(repayMode[1], 'repayMode')">
							...
							{{repayMode[1].name}}<input type="number" v-model.number="selected.partInput" placeholder="请输入部分提前还款额" maxlength="10"/>
...
<script>
const dropSelect = require('@/pages/index/components/common/dropSelect');
const lilvArr = require('@/pages/index/config/lilv');
const Toast = require('@/pages/index/components/common/toast');
